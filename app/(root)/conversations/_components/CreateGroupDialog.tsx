...
const createGroupFormSchema = z.object({
  name: z.string().min(1, { message: "This fied can't be empty" }),
  members: z
    .string()
    .array()
                    ...
                    return (
                      ...
                      >
                        <div className="relative">
                          ...
                          <X
                            className=" text-muted-foreground size-4 absolute bottom-8 left-7 bg-muted rounded-full cursor-pointer "
                            onClick={() => {
                              form.setValue(
                                "members",
